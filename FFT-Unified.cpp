...
/*
    FFT-004 FFT 알고리즘 구현 - 역비트순, Bit-reversed Order, 루프 방식, 복소수근의 성질, Power of Two By Reduction
        https://www.youtube.com/watch?v=WIQrEDF84OI&list=PLsIvhalfft1EIFfhKWDelIbHtGSTVpTQg&index=26
...
/*
    FFT-006 루프 방식 C++ FFT 및 IFFT 알고리즘 구현 최종회, 이론 상세 설명, iterative loop FFT
    https://www.youtube.com/watch?v=5ZdQcUc_hbM&list=PLsIvhalfft1EIFfhKWDelIbHtGSTVpTQg&index=28
*/
...
void test_Laurent_vs_Fourier_with_FFT_IFFT()
{
    ...
    fft(fn_cos); fft(fn_sgt_zero); fft(fn_sgt_one);
